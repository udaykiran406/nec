...
public class PortalUserConstants {

    private PortalUserConstants() {}

    public static final String USER_NOT_FOUND         = "Portal user not found with id: ";
    public static final String USER_CREATED           = "Portal user created successfully";
    public static final String USER_UPDATED           = "Portal user updated successfully";
